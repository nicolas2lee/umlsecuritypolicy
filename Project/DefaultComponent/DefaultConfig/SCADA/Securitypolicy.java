...
//!	Generated Date	: Sun, 21, Feb 2016 
	File Path	: DefaultComponent/DefaultConfig/SCADA/Securitypolicy.java
*********************************************************************/
...
public class Securitypolicy implements RiJStateConcept, Animated {
    ...
    public static AnimClass animClassSecuritypolicy = new AnimClass("SCADA.Securitypolicy",false);
    //#]
    ...
    public class Reactive extends RiJStateReactive implements AnimatedReactive {
        ...
        public int Idle_takeEvent(short id) {
            int res = RiJStateReactive.TAKE_EVENT_NOT_CONSUMED;
            if(event.isTypeOf(checkPolicy.checkPolicy_SCADA_id))
                {
        ...
        public int ReceivedToCheck_takeEvent(short id) {
            int res = RiJStateReactive.TAKE_EVENT_NOT_CONSUMED;
            if(event.isTypeOf(notOk.notOk_SCADA_id))
                {
                    res = ReceivedToCheckTakenotOk();
                }
            else if(event.isTypeOf(ok.ok_SCADA_id))
                {
