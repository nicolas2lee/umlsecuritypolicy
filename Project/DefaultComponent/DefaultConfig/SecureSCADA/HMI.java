...
//!	Generated Date	: Mon, 22, Feb 2016 
	File Path	: DefaultComponent/DefaultConfig/SecureSCADA/HMI.java
*********************************************************************/
...
public class HMI implements RiJStateConcept, Animated {
    ...
    public static AnimClass animClassHMI = new AnimClass("SecureSCADA.HMI",false);
    //#]
    ...
    public class Reactive extends RiJStateReactive implements AnimatedReactive {
        ...
        public int signedIn_takeEvent(short id) {
            int res = RiJStateReactive.TAKE_EVENT_NOT_CONSUMED;
            if(event.isTypeOf(queryData.queryData_SecureSCADA_id))
                {
                    res = signedInTakequeryData();
                }
            else if(event.isTypeOf(sendToField.sendToField_SecureSCADA_id))
                {
        ...
        //## statechart_method 
        public int requestDataTakerefusedTask() {
            refusedTask params = (refusedTask) event;
            int res = RiJStateReactive.TAKE_EVENT_NOT_CONSUMED;
        ...
        public int Idle_takeEvent(short id) {
            int res = RiJStateReactive.TAKE_EVENT_NOT_CONSUMED;
            if(event.isTypeOf(signin.signin_SecureSCADA_id))
                {
                    res = IdleTakesignin();
                }
        ...
        //## statechart_method 
        public int sentToFieldTakeapprovedTask() {
            int res = RiJStateReactive.TAKE_EVENT_NOT_CONSUMED;
        ...
        public int requestData_takeEvent(short id) {
            ...
            if(event.isTypeOf(doneService.doneService_SecureSCADA_id))
                {
                    res = requestDataTakedoneService();
                }
            else if(event.isTypeOf(refusedTask.refusedTask_SecureSCADA_id))
                {
                    res = requestDataTakerefusedTask();
                }
        ...
        //## statechart_method 
        public int sentToFieldTakerefusedTask() {
            refusedTask params = (refusedTask) event;
            int res = RiJStateReactive.TAKE_EVENT_NOT_CONSUMED;
        ...
        //## statechart_method 
        public int requestDataTakedoneService() {
            int res = RiJStateReactive.TAKE_EVENT_NOT_CONSUMED;
        ...
        public int sentToField_takeEvent(short id) {
            int res = RiJStateReactive.TAKE_EVENT_NOT_CONSUMED;
            if(event.isTypeOf(approvedTask.approvedTask_SecureSCADA_id))
                {
                    res = sentToFieldTakeapprovedTask();
                }
            else if(event.isTypeOf(refusedTask.refusedTask_SecureSCADA_id))
                {
                    res = sentToFieldTakerefusedTask();
                }
