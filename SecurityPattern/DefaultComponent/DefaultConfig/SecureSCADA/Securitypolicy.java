...
//!	Generated Date	: Mon, 22, Feb 2016 
	File Path	: DefaultComponent/DefaultConfig/SecureSCADA/Securitypolicy.java
*********************************************************************/
...
//----------------------------------------------------------------------------
// SecureSCADA/Securitypolicy.java                                                                  
//----------------------------------------------------------------------------
...
public class Securitypolicy implements RiJStateConcept, Animated {
    ...
    public static AnimClass animClassSecuritypolicy = new AnimClass("SecureSCADA.Securitypolicy",false);
    //#]
    ...
    public static final int Securitypolicy_Timeout_Valid_id = 1;		//## ignore 
    
    public static final int Securitypolicy_Timeout_Invalid_id = 2;		//## ignore 
    ...
    //## operation checkingPolicy() 
    public void checkingPolicy() {
        try {
            animInstance().notifyMethodEntered("checkingPolicy",
               new ArgData[] {
               });
    ...
    public class Reactive extends RiJStateReactive implements AnimatedReactive {
        ...
        public void InvalidExit() {
            itsRiJThread.unschedTimeout(Securitypolicy_Timeout_Invalid_id, this);
        }
        
        //## statechart_method 
        public void InvalidEnter() {
            itsRiJThread.schedTimeout(1, Securitypolicy_Timeout_Invalid_id, this, "ROOT.Invalid");
        }
        ...
        public int Idle_takeEvent(short id) {
            int res = RiJStateReactive.TAKE_EVENT_NOT_CONSUMED;
            if(event.isTypeOf(checkPolicy.checkPolicy_SecureSCADA_id))
                {
        ...
        public int ValidTakeRiJTimeout() {
            int res = RiJStateReactive.TAKE_EVENT_NOT_CONSUMED;
            if(event.getTimeoutId() == Securitypolicy_Timeout_Valid_id)
                {
        ...
        public void ValidEnter() {
            itsRiJThread.schedTimeout(1, Securitypolicy_Timeout_Valid_id, this, "ROOT.Valid");
        }
        ...
        public int ReceivedToCheckTakenotOk() {
            ...
            //#[ transition 1 
            getP_sp_check().gen(new rejected());
            //#]
            Invalid_entDef();
        ...
        public int ReceivedToCheckTakeok() {
            ...
            ReceivedToCheck_exit();
            //#[ transition 3 
            getP_sp_check().gen(new approved());
            //#]
            Valid_entDef();
        ...
        public int InvalidTakeRiJTimeout() {
            int res = RiJStateReactive.TAKE_EVENT_NOT_CONSUMED;
            if(event.getTimeoutId() == Securitypolicy_Timeout_Invalid_id)
                {
        ...
        public int ReceivedToCheck_takeEvent(short id) {
            int res = RiJStateReactive.TAKE_EVENT_NOT_CONSUMED;
            if(event.isTypeOf(notOk.notOk_SecureSCADA_id))
                {
                    res = ReceivedToCheckTakenotOk();
                }
            else if(event.isTypeOf(ok.ok_SecureSCADA_id))
                {
        ...
        public void ValidExit() {
            itsRiJThread.unschedTimeout(Securitypolicy_Timeout_Valid_id, this);
        }
