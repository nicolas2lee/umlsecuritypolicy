...
//!	Generated Date	: Sun, 21, Feb 2016 
	File Path	: DefaultComponent/DefaultConfig/SCADA/Checkpoint.java
*********************************************************************/
...
public class Checkpoint implements RiJStateConcept, Animated {
    ...
    public static AnimClass animClassCheckpoint = new AnimClass("SCADA.Checkpoint",false);
    //#]
    ...
    public class Reactive extends RiJStateReactive implements AnimatedReactive {
        ...
        public int IdentificationRight_takeEvent(short id) {
            int res = RiJStateReactive.TAKE_EVENT_NOT_CONSUMED;
            if(event.isTypeOf(allow.allow_SCADA_id))
                {
                    res = IdentificationRightTakeallow();
                }
            else if(event.isTypeOf(notAllow.notAllow_SCADA_id))
                {
        ...
        public int Idle_takeEvent(short id) {
            int res = RiJStateReactive.TAKE_EVENT_NOT_CONSUMED;
            if(event.isTypeOf(checkLogin.checkLogin_SCADA_id))
                {
